...
grant usage on schema hnm to admin;
grant all privileges on story, story_id_seq, link, link_id_seq, story_site, story_site_id_seq to admin;
grant select on site to admin;
