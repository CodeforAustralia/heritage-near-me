...
Elm.Swipe.make = function (_elm) {
   ...
   if (_elm.Swipe.values) return _elm.Swipe.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var _op = {};
   var swipeId = function (state) {
      var _p0 = state;
      switch (_p0.ctor)
      {case "Start": return _p0._0.id;
         case "Swiping": return _p0._0.id;
   ...
   var direction = F2(function (dx,dy) {
      return _U.cmp($Basics.abs(dx),$Basics.abs(dy)) > 0 ? _U.cmp(dx,0) > 0 ? $Maybe.Just(Right) : _U.cmp(dx,
      0) < 0 ? $Maybe.Just(Left) : $Maybe.Nothing : _U.cmp(dy,0) > 0 ? $Maybe.Just(Down) : _U.cmp(dy,0) < 0 ? $Maybe.Just(Up) : $Maybe.Nothing;
   });
   var End = function (a) {    return {ctor: "End",_0: a};};
   var Swiping = function (a) {    return {ctor: "Swiping",_0: a};};
   var Start = function (a) {    return {ctor: "Start",_0: a};};
   var update = F2(function (touch,swipeState) {
      var _p1 = swipeState;
      switch (_p1.ctor)
   ...
   var swipeStates = function () {
      var updates = F2(function (touches,states) {
         ...
         A2($List.concatMap,
         function (state) {
            var newTouches = A2($List.filter,function (t) {    return _U.eq(swipeId(state),t.id);},touches);
            if ($List.isEmpty(newTouches)) {
                  var _p6 = state;
                  switch (_p6.ctor)
                  {case "Start": return _U.list([]);
                     case "Swiping": return _U.list([End(_p6._0)]);
                     default: return _U.list([]);}
               } else return A2($List.filterMap,function (touch) {    return A2(update,touch,state);},newTouches);
         },
         states),
         A2($List.map,
         function (touch) {
      ...
      return A3($Signal.foldp,updates,_U.list([]),$Touch.touches);
   }();
   var swipes = function () {
      var isSwiping = function (swipe) {
         var _p7 = swipe;
         switch (_p7.ctor)
         {case "Start": return $Maybe.Nothing;
            case "Swiping": return $Maybe.Nothing;
            default: return $Maybe.Just(_p7._0);}
      };
      return A2($Signal.map,$List.filterMap(isSwiping),swipeStates);
   }();
   var SwipeStart = F4(function (a,b,c,d) {    return {x: a,y: b,id: c,t0: d};});
   var Swipe = F7(function (a,b,c,d,e,f,g) {    return {x0: a,y0: b,x1: c,y1: d,id: e,direction: f,t0: g};});
   return _elm.Swipe.values = {_op: _op
                              ,swipes: swipes
...
Elm.Types.make = function (_elm) {
   ...
   var Discovery = F5(function (a,b,c,d,e) {    return {item: a,swipePos: b,items: c,favourites: d,passes: e};});
   ...
   var SwipingItem = function (a) {    return {ctor: "SwipingItem",_0: a};};
...
Elm.Discover.make = function (_elm) {
   ...
   var _op = {};
   var styleStory = function (pos) {
      var _p0 = pos;
      if (_p0.ctor === "Just") {
            return _U.list([{ctor: "_Tuple2",_0: "position",_1: "relative"}
                           ,{ctor: "_Tuple2",_0: "left",_1: A2($Basics._op["++"],$Basics.toString(_p0._0),"px")}]);
         } else {
            return _U.list([]);
         }
   };
   ...
   var view = F2(function (address,app) {
      ...
      _U.list([function () {
                 var _p1 = app.item;
                 if (_p1.ctor === "Just") {
                       return A3(viewStory,address,_p1._0,app.swipePos);
                    } else {
...
Elm.Favourites.make = function (_elm) {
   "use strict";
   _elm.Favourites = _elm.Favourites || {};
   if (_elm.Favourites.values) return _elm.Favourites.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
...
Elm.Swiping.make = function (_elm) {
   ...
   var swipeAction = function (swipe) {
      ...
      if (_p0.ctor === "Just") {
            switch (_p0._0.ctor)
            {case "Start": return $Maybe.Nothing;
               case "Swiping": var _p1 = _p0._0._0;
                 return $Maybe.Just($Types.SwipingItem(_p1.x1 - _p1.x0));
               default: var _p2 = _p0._0._0.direction;
                 switch (_p2.ctor)
                 {case "Right": return $Maybe.Just($Types.Favourite);
                    case "Left": return $Maybe.Just($Types.Pass);
                    default: return $Maybe.Nothing;}}
         } else {
            return $Maybe.Nothing;
         }
   };
   var swipeActions = A3($Signal.filterMap,swipeAction,$Types.NoAction,swipes);
   return _elm.Swiping.values = {_op: _op,swipeActions: swipeActions};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $Types = Elm.Types.make(_elm);
   var _op = {};
   var exampleStory = {title: "Foundations laid for the first Town Hall site in Parramatta."
                      ,photo: "data:image/jpeg;base64,"
   ...
   var exampleStories = {item: $Maybe.Just(exampleStory)
                        ,items: A2($List.indexedMap,
                        F2(function (i,story) {
                           return _U.update(story,{title: A2($Basics._op["++"],$Basics.toString(i),A2($Basics._op["++"],": ",story.title))});
                        }),
                        A2($List.repeat,10,exampleStory))
                        ,favourites: _U.list([])
                        ,passes: _U.list([])
                        ,swipePos: $Maybe.Nothing};
   var exampleApp = {location: $Types.Discovering,discovery: exampleStories};
   var swipeItem = F2(function (app,pos) {    return _U.update(app,{swipePos: $Maybe.Just(pos)});});
   var passItem = function (app) {
      ...
      ,passes: function () {
         var _p0 = app.item;
         if (_p0.ctor === "Just") {
               return A2($Basics._op["++"],app.passes,_U.list([_p0._0]));
            } else {
               return app.passes;
            }
      }()
   ...
   var favouriteItem = function (app) {
      ...
      ,favourites: function () {
         var _p1 = app.item;
         if (_p1.ctor === "Just") {
               return A2($Basics._op["++"],app.favourites,_U.list([_p1._0]));
            } else {
   ...
   var update = F2(function (action,app) {
      ...
      switch (_p2.ctor)
      {case "Discovering": var _p3 = action;
           switch (_p3.ctor)
           {case "Discover": return _U.update(app,{location: $Types.Discovering});
              case "View": return _U.update(app,{location: $Types.Viewing(_p3._0)});
              ...
              case "SwipingItem": return _U.update(app,{discovery: A2(swipeItem,app.discovery,_p3._0)});
              default: return app;}
         case "Viewing": var _p4 = action;
           switch (_p4.ctor)
           {case "Discover": return _U.update(app,{location: $Types.Discovering});
              case "View": return _U.update(app,{location: $Types.Viewing(_p4._0)});
              case "ViewFavourites": return _U.update(app,{location: $Types.ViewingFavourites});
              default: return app;}
         default: var _p5 = action;
           switch (_p5.ctor)
           {case "Discover": return _U.update(app,{location: $Types.Discovering});
              case "View": return _U.update(app,{location: $Types.Viewing(_p5._0)});
              case "ViewFavourites": return _U.update(app,{location: $Types.ViewingFavourites});
              default: return app;}}
   });
