...
Elm.Date.I18n.I_en_us.make = function (_elm) {
   ...
   if (_elm.Date.I18n.I_en_us.values) return _elm.Date.I18n.I_en_us.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Date = Elm.Date.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   return _elm.Date.I18n.I_en_us.values = {_op: _op,dayShort: dayShort,dayName: dayName,monthShort: monthShort,monthName: monthName};
};
Elm.Date = Elm.Date || {};
Elm.Date.Config = Elm.Date.Config || {};
...
Elm.Date.Config.Config_en_us.make = function (_elm) {
   ...
   if (_elm.Date.Config.Config_en_us.values) return _elm.Date.Config.Config_en_us.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Date = Elm.Date.make(_elm),
   $Date$Config = Elm.Date.Config.make(_elm),
   ...
   var config = {i18n: {dayShort: $Date$I18n$I_en_us.dayShort
                ...
                ,format: {date: "%-m/%-d/%Y"
                         ...
                         ,firstDayOfWeek: $Date.Mon}};
   return _elm.Date.Config.Config_en_us.values = {_op: _op,config: config};
};
Elm.Date = Elm.Date || {};
...
Elm.Date.Format.make = function (_elm) {
   ...
   var formatToken = F4(function (config,offset,d,m) {
      ...
      {case "Y": return A3(padWithN,4,_U.chr("0"),$Date.year(d));
         case "m": return A2(padWith,_U.chr("0"),$Date$Core.monthToInt($Date.month(d)));
         case "_m": return A2(padWith,_U.chr(" "),$Date$Core.monthToInt($Date.month(d)));
         case "-m": return $Basics.toString($Date$Core.monthToInt($Date.month(d)));
   ...
   var formatOffset = F4(function (config,offset,formatStr,date) {
      ...
      return A4($Regex.replace,$Regex.All,formatRegex,A3(formatToken,config,offset,A2($Date$Internal.hackDateAsOffset,hackOffset,date)),formatStr);
   });
   var format = F3(function (config,formatStr,date) {    return A4(formatOffset,config,$Date$Create.getTimezoneOffset(date),formatStr,date);});
   ...
   var isoDateString = function (date) {
      ...
      "-",
      A2($Basics._op["++"],
      A3($String.padLeft,2,_U.chr("0"),$Basics.toString($Date$Core.monthToInt(month))),
      A2($Basics._op["++"],"-",A3($String.padLeft,2,_U.chr("0"),$Basics.toString(day))))));
   };
   var utcIsoDateString = function (date) {    return isoDateString($Date$Internal.hackDateAsUtc(date));};
   ...
   var monthMonth = function (month) {    return A3($String.padLeft,2,_U.chr("0"),$Basics.toString($Date$Core.monthToInt(month)));};
   var month = function (date) {    return A3($String.padLeft,2,_U.chr("0"),$Basics.toString($Date$Core.monthToInt($Date.month(date))));};
   var isoTimeFormat = "%H:%M:%S";
   var isoDateFormat = "%Y-%m-%d";
   var isoMsecOffsetFormat = "%Y-%m-%dT%H:%M:%S.%L%z";
   var isoString = A2(format,$Date$Config$Config_en_us.config,isoMsecOffsetFormat);
   var isoOffsetFormat = "%Y-%m-%dT%H:%M:%S%z";
   var isoMsecFormat = "%Y-%m-%dT%H:%M:%S.%L";
   var utcIsoString = function (date) {    return A2($Basics._op["++"],A3(formatUtc,$Date$Config$Config_en_us.config,isoMsecFormat,date),"Z");};
...
Elm.Remote.Data.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var isFailed = function (data) {    var _p0 = data;if (_p0.ctor === "Failed") {    return true;} else {    return false;}};
   var isLoaded = function (data) {    var _p1 = data;if (_p1.ctor === "Loaded") {    return true;} else {    return false;}};
   var isLoading = function (data) {    var _p2 = data;if (_p2.ctor === "Loading") {    return true;} else {    return false;}};
   var get = function (data) {    var _p3 = data;if (_p3.ctor === "Loaded") {    return $Maybe.Just(_p3._0);} else {    return $Maybe.Nothing;}};
...
Elm.Remote.DataStore.make = function (_elm) {
   ...
   if (_elm.Remote.DataStore.values) return _elm.Remote.DataStore.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   var loaded = function (_p0) {    var _p1 = _p0;return A2($List.filterMap,$Remote$Data.get,$Dict.values(_p1._0));};
   var get = F2(function (id,_p2) {    var _p3 = _p2;return A2($Maybe.withDefault,$Remote$Data.Loading,A2($Dict.get,$Basics.toString(id),_p3._0));});
   ...
   var fetchInsert = F2(function (id,request) {    return A3(fetch,id,request,updateIfLoaded);});
...
Elm.Types.make = function (_elm) {
   ...
   var Returning = F5(function (a,b,c,d,e) {    return {ctor: "Returning",_0: a,_1: b,_2: c,_3: d,_4: e};});
...
Elm.Swiping.make = function (_elm) {
   ...
   var windowSize = A3($Signal.map2,F2(function (w,h) {    return {width: $Basics.toFloat(w),height: $Basics.toFloat(h)};}),$Window.width,$Window.height);
      ...
      _v7_5: do {
         ...
         {case "Swiping": if (_p14._0.ctor === "Swiping") {
            ...
            case "Leaving": var _p17 = _p14._2;
              var _p16 = _p14._1;
              return $Maybe.Just(A6($Easing.ease,$Easing.easeOutCubic,$Easing.$float,_p16,_p14._0.width * sign(_p16),_p14._3 - _p17,_p14._4 - _p17));
            case "Returning": var _p18 = _p14._2;
              return $Maybe.Just(A6($Easing.ease,$Easing.easeOutCubic,$Easing.$float,_p14._1,0,_p14._3 - _p18,_p14._4 - _p18));
            default: break _v7_5;}
      } while (false);
      return $Maybe.Nothing;
   };
   var animateStep = F3(function (t,window,state) {
      var _p19 = state;
      switch (_p19.ctor)
      {case "Leave": return A5($Types.Leaving,window,_p19._0,t,t + 600,t);
         case "Return": return A5($Types.Returning,window,_p19._0,t,t + 600,t);
         case "Leaving": return A5($Types.Leaving,window,_p19._1,_p19._2,_p19._3,t);
         case "Returning": return A5($Types.Returning,window,_p19._1,_p19._2,_p19._3,t);
         default: return _p19;}
   });
   var animate = A3($Signal.map2,$Types.Animate,timeSoFar,windowSize);
...
Elm.Story.make = function (_elm) {
         ...
         if (_p0.ctor === "_Tuple2") {
               if (_p0._0.ctor === "Nothing") {
                     ...
                     if (_p0._1.ctor === "Nothing") {
                           ...
                           return $Maybe.Just(A2($Basics._op["++"],A2(dateFormat,"%Y",_p0._0._0),A2($Basics._op["++"]," - ",A2(dateFormat,"%Y",_p0._1._0))));
                        }
                  }
            } else {
               break _v0_3;
   ...
   var toMdQuote = function (quote) {    return A2($Basics._op["++"],"<blockquote class=\'featured-quote\'>",A2($Basics._op["++"],quote,"</blockquote>"));};
   var addQuote = F2(function (quote,story) {
      var _p10 = {ctor: "_Tuple2",_0: quote,_1: story};
      if (_p10._0 === "") {
            if (_p10._1 === "") {
                  return "";
               } else {
            ...
            if (_p10._1 === "") {
                  return toMdQuote(quote);
               } else {
                  var join = function (lines) {    return A2($String.join,"\n\n",lines);};
                  var shortStory = A2($Basics._op["++"],toMdQuote(quote),A2($Basics._op["++"],"\n\n",story));
                  ...
                  if (_p11.ctor === "[]") {
                        ...
                        if (_p11._1.ctor === "[]") {
                              ...
                              if (_p11._1._1.ctor === "[]") {
                                    ...
                                    A2($Basics._op["++"],
                                    _p11._1._0,
                                    A2($Basics._op["++"],"\n\n",A2($Basics._op["++"],toMdQuote(quote),A2($Basics._op["++"],"\n\n",join(_p11._1._1)))))));
                                 }
                           }
                     }
               }
   ...
   var introOrBody = F2(function (story,storyScreen) {
      ...
      if (_p13._0.ctor === "FullStory") {
            if (_p13._1.ctor === "Intro") {
                  return A2($Html.p,_U.list([]),_U.list([$Html.text(_p13._0._0.blurb)]));
               } else {
                  var _p14 = _p13._0._0;
   ...
   var storyButton = F3(function (address,story,storyScreen) {
      var _p15 = {ctor: "_Tuple2",_0: story,_1: storyScreen};
      if (_p15._0.ctor === "FullStory" && _p15._1.ctor === "Intro") {
            return A2($Html.a,
            _U.list([$Html$Attributes.$class("btn btn-story"),A2($Html$Events.onClick,address,A2($Types.View,_p15._0._0.id,$Types.Body))]),
   ...
   var metaHtml = F2(function (story,screen) {
      var _p16 = {ctor: "_Tuple2",_0: story,_1: screen};
      if (_p16._0.ctor === "DiscoverStory") {
            ...
            _U.list([titleHtml(story)
                    ,A2($Html.div,_U.list([$Html$Attributes.$class("fullStory-site")]),_U.list([$Html.text(sitesName(_p20.sites))]))
                    ,function () {
                       var _p17 = _p20.suburb;
                       if (_p17.ctor === "Just") {
                             return A2($Html.div,_U.list([$Html$Attributes.$class("fullStory-suburb")]),_U.list([$Html.text(_p17._0)]));
                          } else {
                             return $Html.text("");
                          }
                    }()
                    ,function () {
                       var _p18 = formatDate(_p20.dates);
                       if (_p18.ctor === "Just") {
                             return A2($Html.div,_U.list([$Html$Attributes.$class("fullStory-date")]),_U.list([$Html.text(_p18._0)]));
                          } else {
                             return $Html.text("");
                          }
                    }()
                    ,function () {
                       var _p19 = distance(story);
                       if (_p19.ctor === "Just") {
                             return A2($Html.p,
                             _U.list([$Html$Attributes.$class("fullStory-distance")]),
                             _U.list([A2($Html.i,_U.list([$Html$Attributes.$class("fa fa-map-marker")]),_U.list([])),$Html.text(" "),$Html.text(_p19._0)]));
                          } else {
                             return A2($Html.p,
   ...
   var view = F4(function (address,story,item,storyScreen) {
      ...
      function () {
         var _p21 = story;
         switch (_p21.ctor)
         {case "Loaded": var _p27 = _p21._0;
              return A2($Basics._op["++"],
              _U.list([A4(photoSlider,address,_p27,item,storyScreen),A2(metaHtml,_p27,storyScreen)]),
              function () {
                 var _p22 = _p27;
                 if (_p22.ctor === "DiscoverStory") {
                       return _U.list([$Loading.loading]);
                    } else {
                       var _p26 = _p22._0;
                       return _U.list([function () {
                                         var _p23 = $List.head(_p26.locations);
                                         if (_p23.ctor === "Just") {
                                               var _p24 = _p23._0;
                                               return A2($Html.div,
                                               ...
                                               _U.list([$Html$Attributes.href(A2($Basics._op["++"],
                                                       ...
                                                       A2($Basics._op["++"],_p24.lat,A2($Basics._op["++"],",",_p24.lng))))
                                      ...
                                      ,A3(storyButton,address,_p27,storyScreen)
                                      ,A2(introOrBody,_p27,storyScreen)
                                      ,function () {
                                         var _p25 = _p26.sites;
                                         if (_p25.ctor === "[]") {
                                               return $Html.text("");
            ...
            case "Failed": return _U.list([A2($Html.div,
              ...
              _U.list([$Html.text("Something went wrong: "),$Html.text($Basics.toString(log(_p21._0)))]))]);
...
Elm.Data.make = function (_elm) {
   ...
   F2(function (start,end) {
      return {start: A2($Maybe.andThen,start,function (_p0) {    return $Result.toMaybe($Date.fromString(_p0));})
             ,end: A2($Maybe.andThen,end,function (_p1) {    return $Result.toMaybe($Date.fromString(_p1));})};
   }),
   ...
   A2($Json$Decode._op[":="],"story",$Json$Decode.oneOf(_U.list([$Json$Decode.string,$Json$Decode.$null("This story hasn\'t been written yet!")])))),
   A2($Json$Decode._op[":="],"quote",$Json$Decode.string)),
   $Json$Decode.maybe(A2($Json$Decode._op[":="],"dates",datesDecoder))),
   ...
   var storyNotFoundError = $Task.fail(A2($Http.BadResponse,404,"Story with given id was not found"));
   var apiUrl = function (subUrl) {    return A2($Http.url,A2($Basics._op["++"],"api/",subUrl),_U.list([]));};
   var apiHttpPostRequest = F3(function (apiMethod,pos,maybeStory) {
      var storyPart = function () {
         var _p3 = maybeStory;
         if (_p3.ctor === "Just") {
               return A2($Basics._op["++"],", \"story_of_interest\": \"",A2($Basics._op["++"],$Basics.toString(_p3._0._0),"\""));
            } else {
               return "";
            }
      }();
      return {verb: "POST"
             ...
             ,url: A2($Basics._op["++"],apiUrl("rpc/"),apiMethod)
             ,body: $Http.string(A2($Basics._op["++"],
             "{\"lat\": \"",
             A2($Basics._op["++"],
             pos.lat,
             A2($Basics._op["++"],"\", \"lng\": \"",A2($Basics._op["++"],pos.lng,A2($Basics._op["++"],"\"",A2($Basics._op["++"],storyPart,"}")))))))};
   });
   var apiHttpPostRequest$ = F2(function (apiMethod,pos) {    return A3(apiHttpPostRequest,apiMethod,pos,$Maybe.Nothing);});
   var requestNearbyStories = function (pos) {
      return A2($Http.fromJson,discoverStories,A2($Http.send,$Http.defaultSettings,A2(apiHttpPostRequest$,"story_discover_by_location",pos)));
   };
   var requestNearbyStory = F2(function (pos,storyId) {
      return A2($Task.andThen,
      A2($Task.map,
      $List.head,
      A2($Http.fromJson,fullStoriesDecoder,A2($Http.send,$Http.defaultSettings,A3(apiHttpPostRequest,"story_details_by_location",pos,$Maybe.Just(storyId))))),
      function (firstStory) {
         return A2($Maybe.withDefault,
         $Task.fail(A2($Http.BadResponse,
         404,
         A2($Basics._op["++"],"Story with ID of \'",A2($Basics._op["++"],$Story.storyIdToStr(storyId),"\' was not found")))),
         A2($Maybe.map,$Task.succeed,firstStory));
      });
   });
   ...
   var viewStory = function (_p5) {
      ...
      function (time) {
         ...
         ,body: $Http.string(A2($Basics._op["++"],
         "{\"datetime\": \"",
         A2($Basics._op["++"],timestamp(time),A2($Basics._op["++"],"\", \"story_id\": \"",A2($Basics._op["++"],$Basics.toString(_p6._0),"\"}")))))}));
      });
   };
   var favouriteStory = F2(function (_p7,favourited) {
      var _p8 = _p7;
      return A2($Task.andThen,
      $Native$TimeTask.getCurrentTime,
      function (time) {
         ...
         "\", \"story_id\": \"",
         A2($Basics._op["++"],
         $Basics.toString(_p8._0),
         A2($Basics._op["++"],"\", \"favourited\": \"",A2($Basics._op["++"],$Basics.toString(favourited),"\"}")))))))}));
      });
   });
   var updateStory = F2(function (newStory,oldStory) {
      var _p9 = {ctor: "_Tuple2",_0: $Remote$Data.get(newStory),_1: A2($Maybe.andThen,oldStory,$Remote$Data.get)};
      if (_p9.ctor === "_Tuple2" && _p9._0.ctor === "Just" && _p9._1.ctor === "Just") {
            var _p10 = {ctor: "_Tuple2",_0: _p9._0._0,_1: _p9._1._0};
            _v4_2: do {
               if (_p10.ctor === "_Tuple2") {
                     if (_p10._0.ctor === "FullStory") {
                           return $Maybe.Just($Remote$Data.Loaded($Types.FullStory(_p10._0._0)));
                        } else {
                           if (_p10._1.ctor === "DiscoverStory") {
                                 return $Maybe.Just($Remote$Data.Loaded($Types.DiscoverStory(_p10._0._0)));
                              } else {
                                 break _v4_2;
                              }
                        }
   ...
   return _elm.Data.values = {_op: _op
                             ...
                             ,requestNearbyStory: requestNearbyStory
              ...
              ,function () {
                 ...
                 {case "Loaded": var _p3 = _p2._0;
                      if (_p3.ctor === "Just") {
                            ...
                            switch (_p4.ctor)
                            {case "Loaded": return A3(viewStory,address,_p4._0,app.discovery.itemPosition);
...
Elm.Favourites.make = function (_elm) {
   ...
   var favouriteImage = function (favourite) {
      ...
      _U.list([$Html$Attributes.$class("image")
              ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                               ,_0: "background-image"
                                               ,_1: A2($Basics._op["++"],"url(\"",A2($Basics._op["++"],$Story.photo(favourite),"\")"))}
                                              ,{ctor: "_Tuple2",_0: "background-repeat",_1: "no-repeat"}
                                              ,{ctor: "_Tuple2",_0: "background-size",_1: "cover"}]))]),
      _U.list([]));
   };
...
Elm.Main.make = function (_elm) {
   ...
   var fetchDiscover = function (requestStoriesTask) {
      var update_ = function (story) {    return A2($Remote$DataStore.update,$Story.id(story),$Data.updateStory($Remote$Data.Loaded(story)));};
      ...
      function (stories) {
         ...
         function (dataStore) {
            return A3($List.foldl,update_,dataStore,stories);
         }));
      }),
      function (error) {
         return $Task.succeed(A2($Types.LoadDiscoveryData,$Remote$Data.Failed(error),$Basics.identity));
      }));
   };
   var tailOrEmptyList = function (list) {    return A2($Maybe.withDefault,_U.list([]),A2($Maybe.andThen,list,$List.tail));};
   ...
   var animateItem = F3(function (discovery,time,window) {
      return _U.update(discovery,{itemPosition: A3($Swiping.animateStep,time,window,discovery.itemPosition)});
   });
   ...
   var favouriteItem = function (app) {
      ...
      ,favourites: function () {
         ...
         if (_p1.ctor === "Loaded" && _p1._0.ctor === "Just") {
               return A2($Basics._op["++"],app.favourites,_U.list([_p1._0._0]));
            } else {
   ...
   var latLngDecoder = A3($Json$Decode.object2,
   F2(function (lat,lng) {    return A2($Debug.log,"attempting LatLng json decode",{lat: $Basics.toString(lat),lng: $Basics.toString(lng)});}),
   ...
   function (_p2) {
      return $Types.UpdateLocation($Result.toMaybe(A2($Json$Decode.decodeValue,latLngDecoder,_p2)));
   },
   ...
   var updateAction = F2(function (action,app) {
      ...
      {case "View": var requestRemoteStory = function () {
         ...
         default: return A2($Debug.log,"updateAction action triggered: ",$Effects.none);}
   });
   var updateDiscoverableItems = F2(function (discovery,items) {
      return _U.eq(discovery,initialDiscovery) ? _U.update(discovery,
   ...
   return _elm.Main.values = {_op: _op
                             ...
                             ,tailOrEmptyList: tailOrEmptyList
